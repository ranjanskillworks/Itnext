...
if ( ! class_exists( 'It_Next_Customize' ) ) {
	/**
	 * Customizer Settings.
	 *
	 * @since It Next 1.0
	 */
	class It_Next_Customize {
		...
		public function register( $wp_customize ) {
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'Display Site Title & Tagline', 'itnext' ),
				)
			);
			...
			$wp_customize->add_section(
				'excerpt_settings',
				array(
					'title'    => esc_html__( 'Excerpt Settings', 'itnext' ),
					'priority' => 120,
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'On Archive Pages, posts show:', 'itnext' ),
					'choices' => array(
						'excerpt' => esc_html__( 'Summary', 'itnext' ),
						'full'    => esc_html__( 'Full text', 'itnext' ),
					),
				)
			);
			...
			$wp_customize->register_control_type( 'It_Next_Customize_Color_Control' );
			...
			$wp_customize->add_control(
				new It_Next_Customize_Color_Control(
					$wp_customize,
					'background_color',
					array(
						'label'   => esc_html_x( 'Background color', 'Customizer control', 'itnext' ),
						'section' => 'colors',
						'palette' => $colors,
					)
				)
